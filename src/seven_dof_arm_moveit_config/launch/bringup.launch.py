...
def generate_launch_description():
    ...
    moveit_config_package = "seven_dof_arm_moveit_config"
    ...
    _robot_description_semantic_xml = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare(moveit_config_package), "config/sevendof_arm.srdf"]
            ),
            " ",
            "name:=",
            name,
    ...
    for controller in ["joint_state_broadcaster", "arm_controller", "griper_controller"]:
        nodes.append(
            Node(
                package="controller_manager",
                executable="spawner",
...
def generate_declared_arguments() -> List[DeclareLaunchArgument]:
    ...
    return [
        ...
        DeclareLaunchArgument(
            "description_package",
            default_value="seven_dof_arm",
            description="Custom package with robot description.",
        ),
        DeclareLaunchArgument(
            "description_filepath",
            default_value="config/seven_dof_arm.urdf.xacro",
            description="Path to xacro or URDF description of the robot, relative to share of `description_package`.",
        ),
        # Naming of the robot
        DeclareLaunchArgument(
            "name",
            default_value="robot_arm7f",
        ...
        DeclareLaunchArgument(
            ...
            default_value=path.join(
                get_package_share_directory("seven_dof_arm_moveit_config"),
                "config",
                "moveit.rviz",
            ),
